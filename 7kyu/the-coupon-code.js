...
//R: return a boolean showing true if code is both valid and not expired
//E: checkCoupon("123", "123", "July 9, 2015", "July 9, 2015")  ===  true
//   checkCoupon("123", "123", "July 9, 2015", "July 2, 2015")  ===  false

function checkCoupon(enteredCode, correctCode, currentDate, expirationDate) {
  //convert date using Date() object
  //conditionals: enteredCode === correctCode, currentDate <= expirationDate
  //return booleen
